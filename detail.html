            ...
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active">Remote control car</li>
                </ol>
              </nav>
            </div>
              ...
              <div id="productMain" class="row">
                <div class="col-md-6">
                  <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                    <div class="item"> <img src="img/sp1.jpg" alt="" class="img-fluid"></div>
                    <div class="item"> <img src="img/sp8.jpg" alt="" class="img-fluid"></div>
                    <div class="item"> <img src="img/sp9.jpg" alt="" class="img-fluid"></div>
                    <div class="item"> <img src="img/sp10.jpg" alt="" class="img-fluid"></div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="box">
                    <h1 class="text-center">Remote control car</h1>
                  ...
                  <div data-slider-id="1" class="owl-thumbs">
                    <button class="owl-thumb-item"><img src="img/sp1.jpg" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item"><img src="img/sp8.jpg" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item"><img src="img/sp9.jpg" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item"><img src="img/sp10.jpg" alt="" class="img-fluid"></button>
                  </div>
                </div>
              </div>
